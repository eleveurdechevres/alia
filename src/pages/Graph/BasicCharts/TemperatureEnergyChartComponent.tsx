...
@observer export class TemperatureEnergyChartComponent extends GenericChartComponent<IProps> {
    ...
    // Chart js object
    private baseChart: TemperatureEnergyBaseChart;
    ...
    constructor(props: IProps) {
        ...
        this.baseChart = new TemperatureEnergyBaseChart(
            this.props.sheet,
            this.totalWidth,
            this.totalHeight,
            this.marginChart
