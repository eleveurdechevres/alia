...
// import { IMargin } from '../BasicCharts/GenericChartComponent';
// import { BaseChart, ILegendItem, svgBorderWidth } from '../BasicCharts/BaseChart';
...
//     public xChart: d3.ScaleLinear<number, number> = d3.scaleLinear();
//     public yChart: d3.ScaleLinear<number, number> = d3.scaleLinear();
//     private yMin: number;
//     private yMax: number;
//     private xAxisChart: d3.Axis<number | { valueOf(): number; }>;
//     private xGridChart: d3.Axis<number | { valueOf(): number; }>;
...
//             this.xChartDomainDefault = [new Date(time_start), new Date(time_end)];
//             this.timeScaleChart.domain(this.xChartDomainDefault).range([0, this.chartWidth]);
//             this.timeAxisChart = d3.axisTop(this.timeScaleChart);
//             this.xAxisChart = d3.axisBottom(this.timeScaleChart);
//         }
//     }
...
//         this.gAxisChartX.transition().call(this.customAxis, this.xAxisChart);
//     }
